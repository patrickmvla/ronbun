        ...
        <div className="rounded-xl border bg-card p-6">
          <Empty>
            <EmptyHeader>
              ...
              <EmptyDescription>
                We couldn’t fetch data from the server. Check your connection
                and try again.
              </EmptyDescription>
            </EmptyHeader>
            <EmptyContent>
        ...
        <>
          ...
          <div className="grid gap-4 md:grid-cols-2">
            {isLoading ? (
              ...
              <PaperColumn paper={paperA} placeholder="A" />
            )}
            {isLoading ? (
              <ColumnSkeleton />
            ) : (
              <PaperColumn paper={paperB} placeholder="B" />
            )}
          </div>
          ...
          <div className="mt-6 rounded-xl border bg-card p-4">
            <div className="mb-1 inline-flex items-center gap-2 text-xs text-muted-foreground">
              ...
              Based on title + abstract (and README if linked). No PDFs or RAG
              in MVP.
            </div>
          </div>
        </>
