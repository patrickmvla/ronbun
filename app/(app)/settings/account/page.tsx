...
const AccountSchema = z.object({
  ...
  email: z.string().email().optional(), // read-only in UI
  categories: z
    .array(z.string())
    .refine((arr) => arr.length > 0, "Select at least one category")
    .refine(
      (arr) => arr.every((c) => DEFAULT_CATS.includes(c as any)),
      "Invalid category"
    ),
...
export default function AccountSettingsPage() {
  ...
  // Load from localStorage (dev-friendly without backend)
  React.useEffect(() => {
    try {
  ...
  // Stable watchers to avoid identity churn in dependencies
      ...
      <div className="flex flex-col gap-2 pb-3 sm:flex-row sm:items-end sm:justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <Button
            variant="outline"
            onClick={() => {
              // Mock sign-out in UI-first setup
        ...
        <section className="space-y-4">
          ...
          <div className="rounded-xl border bg-card p-4">
            ...
            <div className="mt-3">
              ...
              <Segmented
                ...
                onChange={(v) =>
                  form.setValue("defaultView", v as ViewTab, { shouldValidate: true })
                }
                items={[
            ...
            <div className="mt-3">
              ...
              <Segmented
                ...
                onChange={(v) =>
                  form.setValue("explainerLevel", v as ExplainerLevel, { shouldValidate: true })
                }
                items={[
          ...
          <div className="rounded-xl border bg-card p-4">
            ...
            <p className="mt-2 text-xs text-muted-foreground">
              Density preferences apply to tables, lists, and cards.
            </p>
          </div>
        </section>
          ...
          <div className="rounded-xl border bg-card p-4">
            ...
            <label className="mt-1 flex items-center gap-2 text-sm">
              <input
                ...
                onChange={(e) =>
                  form.setValue("digestEnabled", e.target.checked, { shouldValidate: true })
                }
              />
              ...
              <div>
                ...
                <div className="flex items-center gap-2">
                  <Input
                    ...
                    onChange={(e) =>
                      form.setValue("digestTime", e.target.value, { shouldValidate: true })
                    }
                    disabled={!digestEnabled}
